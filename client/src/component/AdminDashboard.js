...
import "./Admin/AdminPages.css"; // We can reuse the admin styling
          ...
          <div className="start-end-container" style={{ marginBottom: '2rem' }}>
            {!this.state.elStarted && !this.state.elEnded ? (
              ...
              <button
                ...
                className="btn-primary"
                style={{ backgroundColor: 'tomato', padding: '15px 30px', fontSize: '1.2rem' }}
              >
                End Election
              </button>
            ) : (
              <p>The election has ended. To start a new one, you must redeploy the contract.</p>
            )}
          </div>
          ...
          <div className="info-card">
            ...
            {this.state.candidates.length === 0 ? (
              <p>
                ...
                <Link to="/admin">add candidates</Link> before starting the election.
              </p>
            ) : (
